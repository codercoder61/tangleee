  ...
  return (
    <div>
      ...
      >
        ...
        <span style={{ color: "white" }}>{data && data && data.name}</span>
        <div>
          <Link style={{ zIndex: "5000" }} to="/imageupload">
            <i
              style={{ color: "white", margin: "5px" }}
              className="fa-solid fa-pen-to-square"
            ></i>
          </Link>
          <Link style={{ zIndex: "5000" }} to="/">
            <i
              style={{ color: "white", margin: "5px" }}
      ...
      >
        ...
        >
          ...
          <span>
            Number of Children: {data && data && data.numberOfChildren}
          </span>
          <span>Profession: {data && data && data.profession}</span>
          <span>
            Employment Status: {data && data && data.employmentStatus}
          </span>
